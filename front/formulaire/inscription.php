...
<form class="flex flex-col justify-center gap-6 w-full items-center" action="./process/process_inscription.php" method="post">
    ...
    <input class="bg-[#df6072] p-2 py-3 w-[70%] cursor-pointer mt-4 rounded-2xl shadow-xl" type="submit">
</form>

<p class="pt-5 font-extralight">Dejà un compte? <a class="text-[#df6072]" href="./login.php">Connectez vous</a></p>

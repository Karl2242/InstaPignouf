...
<body class="bg-noir-bleu text-white">
    ...
    <div class="w-full flex flex-col justify-center items-center mt-24 gap-6 text-center">
        ...
        <main class="flex flex-col">
            ...
            ?>
            <form class="flex flex-col justify-center gap-6 w-full items-center" action="../../process/process_login.php" method="post">
            ...
            <p class="pt-5 font-extralight">Pas encore de compte ?<a class="text-[#df6072]" href="../formulaire/inscription.php"> Inscrivez vous</a></p>
